    ...
    <footer className="bg-slate-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">EpicEsports India</h3>
            <p className="text-gray-300 mb-4">
              Uniting Gamers, Colleges, and Industry Stakeholders in a Vibrant Online Ecosystem
            </p>
            <div className="flex space-x-4">
              <a href="https://discord.gg/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a href="mailto:shubhamkush012@gmail.com" className="text-gray-300 hover:text-white transition-colors">
                  shubhamkush012@gmail.com
                </a>
              </li>
              <li className="flex items-start">
                <span className="text-gray-300 mr-2">Tel:</span>
                <a href="tel:8824013820" className="text-gray-300 hover:text-white transition-colors">
                  8824013820
                </a>
              </li>
            </ul>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                ...
                className="px-4 py-2 bg-slate-800 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
              <button 
                type="submit" 
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-300">
            &copy; {new Date().getFullYear()} EpicEsports India. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
